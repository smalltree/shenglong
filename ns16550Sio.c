...
void ns16550DevInit
    ...
    pChan->channelMode  = SIO_MODE_INT;    /* undefined */
...
LOCAL void ns16550InitChannel
	...
	/* set INT mode, added by yinwx */

	/*ns16550Ioctl(pChan, SIO_MODE_SET, SIO_MODE_INT);*/
    }
