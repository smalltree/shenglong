...
#define FLOW_CONTROL_TIMER_VALUE        0x100	/* 512ns*256=131ms */
#define FLOW_CONTROL_LOW_THRESH         0x4000	/* 16K */
#define FLOW_CONTROL_HIGH_THRESH        0xA000	/* 40K, original is 0x8000(32K) */
